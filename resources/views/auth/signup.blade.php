...
<body>
    ...
    <form class="w-50 d-block mx-auto my-5" method="POST" action="{{ route('signup.send_data') }}">
        @if (Session::get('failed'))
            <div class="alert alert-danger my-3">{{ Session::get('failed', 'Gagal memperoleh data! Silahkan coba lagi!') }}</div>
        @endif
        @csrf
        {{-- digunakan untuk generate token yang di perlukan server dan identify dari form ke controller--}}
        {{-- mekanisme perlindungan terhadap serangan Cross-Site Request Forgery(CSRF) di dalam sebuah aplikasi web, terutama dalam framework seperti Laravel --}}
        ...
        <div class="row mb-4">
            <div class="col">
                ...
                <div data-mdb-input-init class="form-outline">
                    <input type="text" id="form3Example1" class="form-control" @error('firt_name') is-invalid @enderror
                        name="first_name" />
