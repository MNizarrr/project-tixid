        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Ticket Aktif</button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <div class="container mt-4">
                    <h5>Data Tiket untuk hari ini & Besokp</h5>
                    <div class="d-flex flex-wrap">
                        @foreach ($ticketActive as $active)
                            <div class="w-25 me-3" style="border: 1px solid #eaeaea; padding: 8px; ">
                                ...
                                <br>
                                <p>Tanggal :
                                    {{ \Carbon\Carbon::parse($active['ticketPayment']['booked_date'])->format('d F, Y') }}</p>
                                <p>Waktu : {{ \Carbon\Carbon::parse($active['hour'])->format('H:i') }} WIB</p>
                    ...
                    <div class="d-flex flex-wrap">
                        @foreach ($ticketNonActive as $nonActive)
                            <div class="w-25 me-3" style="border: 1px solid #eaeaea; padding: 8px; ">
                                ...
                                <br>
                                <p>Tanggal : <span class="text-danger">
                                    {{ \Carbon\Carbon::parse($nonActive['ticketPayment']['booked_date'])->format('d F, Y') }}</p>
                                <p>Waktu : {{ \Carbon\Carbon::parse($nonActive['hour'])->format('H:i') }} WIB </span></p>
