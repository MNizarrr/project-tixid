...
<div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel" data-mdb-carousel-init>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img style="height: 480px" src="https://asset.tix.id/microsite_v2/d2b394a8-caae-4e0b-b455-7fdb2139ec29.webp" class="d-block w-100" alt="Sunset Over the City"/>
    ...
    <div class="carousel-item">
      <img style="height: 480px" src="https://asset.tix.id/microsite_v2/c0ca475a-7eeb-44c4-b556-8adf89af790c.jpeg" class="d-block w-100" alt="Canyon at Nigh"/>
      <div class="carousel-caption d-none d-md-block">
    ...
    <!-- Single item -->
    <div class="carousel-item">
      <img style="height: 480px" src="https://asset.tix.id/microsite_v2/4b5ba50f-6183-419c-8236-9f1b06a436d9.webp" class="d-block w-100" alt="Cliff Above a Stormy Sea"/>
      <div class="carousel-caption d-none d-md-block">
...
<div class="card" style="width: 18rem;">
  <img src="https://image.idntimes.com/post/20250416/snapinsai-477004280-18485421835006672-4852778433147173690-n-1080-183adc7113c71cf1ce1dc4eea11f86e1.jpg" class="card-img-top" alt="Sunset Over the Sea" style="height: 400px; object-fit: cover;"/>
  ...
  <div class="card-body bg-primary text-warning" style="padding: 0 !important">
    {{-- karna default card-text ada paddingnya, biar padding yg di baca dr style jd dikasi !important(memprioritaskan styling) --}}
...
<div class="card" style="width: 18rem;">
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuHSINxOkY8lAFeQjCTMpSNWjPP9FdegiP4PR586c_CWyiAwTvt1sMYua3FomRMlSugso&usqp=CAU" class="card-img-top" alt="Sunset Over the Sea" style="height: 400px; object-fit: cover;"/>
  {{-- objeck-fit : cover -> gambar ukurannya sesuai dengan aturan height dan width --}}
  <div class="card-body bg-primary text-warning" style="padding: 0 !important">
    {{-- karna default card-text ada paddingnya, biar padding yg di baca dr style jd dikasi !important(memprioritaskan styling) --}}
    <p class="card-text" style="padding: 0 !important; text-align: center; font-weight: bold;">
...
<div class="card" style="width: 18rem;">
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYYU0HmHsw5VSBTO-46F-EmBYLptuaDPFnAw&s" class="card-img-top" alt="Sunset Over the Sea" style="height: 400px; object-fit: cover;"/>
  {{-- objeck-fit : cover -> gambar ukurannya sesuai dengan aturan height dan width --}}
  <div class="card-body bg-primary text-warning" style="padding: 0 !important">
    {{-- karna default card-text ada paddingnya, biar padding yg di baca dr style jd dikasi !important(memprioritaskan styling) --}}
    <p class="card-text" style="padding: 0 !important; text-align: center; font-weight: bold;">
